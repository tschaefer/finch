...
func (h *handler) CreateAgent(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&p); err != nil {
		h.makeLog(r, http.StatusBadRequest, slog.LevelError)
	...
	if err != nil {
		...
		h.makeLog(r, status, slog.LevelError)
		h.makeError(w, status, err.Error())
		return
	}

	h.makeLog(r, http.StatusCreated, slog.LevelInfo)
...
func (h *handler) DeleteAgent(w http.ResponseWriter, r *http.Request) {
	...
	h.makeLog(r, http.StatusNoContent, slog.LevelInfo)
...
func (h *handler) GetAgent(w http.ResponseWriter, r *http.Request) {
	...
	h.makeLog(r, http.StatusOK, slog.LevelInfo)
...
func (h *handler) ListAgents(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		h.makeLog(r, http.StatusInternalServerError, slog.LevelError)
